...
BOOL CheckButtonPressed(void)
{
    static char buttonPressed = FALSE;					//press intial to FALSE
    static unsigned long buttonPressCounter = 0;		//counter == 0

	char press = 0X50;									//button press
	char notPress = 0x4F;
